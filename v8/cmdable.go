...
func (m *ClientMock) LPushX(ctx context.Context, key string, value ...interface{}) *redis.IntCmd {
	if !m.hasStub("LPushX") {
		return m.client.LPushX(ctx, key, value)
	}
...
func (m *ClientMock) RPushX(ctx context.Context, key string, value ...interface{}) *redis.IntCmd {
	if !m.hasStub("RPushX") {
		return m.client.RPushX(ctx, key, value)
	}
